...
class FFriends extends StatefulWidget {
  List allFriends;
  @override
  FFriends({required this.allFriends});

  @override
  State<FFriends> createState() => _FFriendsState();
}

class _FFriendsState extends State<FFriends> {
  bool typed = false;
  bool loaded = false;
  List friendLst = [];
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: Icon(Icons.navigate_next,
                        ...
                        size: (_height *
                            30 /
                            812)), // colour of background on emulator
                    onTap: () {
