...
class FFirebaseProfileSetupService {
  ...
  Future<bool> createUserProfile({
    ...
    // initlising the friend requests doc for the user
    await friendRequests.doc(UID).set({"exists": true, "count": 0});

    // creating a doc for the user's phone number record
    await phoneNumberRef.doc(UID).set({
      "uid": UID,
      "phoneNumber": phoneNumber,
      "hash": hashString(data: phoneNumber)
    });
